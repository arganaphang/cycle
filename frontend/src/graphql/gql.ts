...
const documents: Documents = {
  ...
  "\n  query TreatmentSessionDetail($id: UUID!) {\n    treatmentSession(id: $id) {\n      id\n      session_no\n      session_date\n      status\n      note\n      created_at\n      updated_at\n      patient {\n        id\n        full_name\n        medical_record_no\n        date_of_birth\n        gender\n        phone\n        email\n        address\n      }\n      staff {\n        id\n        full_name\n        specialization\n        license_no\n        phone\n      }\n      report {\n        id\n        anamnesis\n        mechanism_of_injury\n        actual_condition\n        examination\n        diagnosis\n        intervention\n        planning_and_education\n        created_at\n        updated_at\n      }\n    }\n  }\n":
    types.TreatmentSessionDetailDocument,
  "\n  query TreatmentSessionReportDetail($id: UUID!) {\n    treatmentSessionReport(id: $id) {\n      id\n      anamnesis\n      mechanism_of_injury\n      actual_condition\n      examination\n      diagnosis\n      intervention\n      planning_and_education\n      created_at\n      updated_at\n      treatment_session {\n        id\n        session_no\n        session_date\n        status\n        note\n        patient {\n          id\n          full_name\n          medical_record_no\n          date_of_birth\n          gender\n          phone\n          email\n          address\n        }\n        staff {\n          id\n          full_name\n          specialization\n          license_no\n          phone\n        }\n      }\n    }\n  }\n":
    types.TreatmentSessionReportDetailDocument,
};
...
export function graphql(
  source: "\n  query TreatmentSessionDetail($id: UUID!) {\n    treatmentSession(id: $id) {\n      id\n      session_no\n      session_date\n      status\n      note\n      created_at\n      updated_at\n      patient {\n        id\n        full_name\n        medical_record_no\n        date_of_birth\n        gender\n        phone\n        email\n        address\n      }\n      staff {\n        id\n        full_name\n        specialization\n        license_no\n        phone\n      }\n      report {\n        id\n        anamnesis\n        mechanism_of_injury\n        actual_condition\n        examination\n        diagnosis\n        intervention\n        planning_and_education\n        created_at\n        updated_at\n      }\n    }\n  }\n",
): typeof import("./graphql").TreatmentSessionDetailDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "\n  query TreatmentSessionReportDetail($id: UUID!) {\n    treatmentSessionReport(id: $id) {\n      id\n      anamnesis\n      mechanism_of_injury\n      actual_condition\n      examination\n      diagnosis\n      intervention\n      planning_and_education\n      created_at\n      updated_at\n      treatment_session {\n        id\n        session_no\n        session_date\n        status\n        note\n        patient {\n          id\n          full_name\n          medical_record_no\n          date_of_birth\n          gender\n          phone\n          email\n          address\n        }\n        staff {\n          id\n          full_name\n          specialization\n          license_no\n          phone\n        }\n      }\n    }\n  }\n",
): typeof import("./graphql").TreatmentSessionReportDetailDocument;
