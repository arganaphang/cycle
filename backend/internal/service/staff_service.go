...
type StaffService interface {
	FindAll(ctx context.Context, search *string, limit *int, offset *int) ([]*model.Staff, *int, error)
...
func (s *staffService) FindAll(ctx context.Context, search *string, limit *int, offset *int) ([]*model.Staff, *int, error) {
